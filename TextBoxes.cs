...
public class TuiFramedScrollingTextBoxDate : TuiFramedScrollingTextBox{
	
	public TuiFramedScrollingTextBoxDate(string chars, string t, uint bl, Placement p, int x, int y, CharFormat? ff, CharFormat? sff, CharFormat? tf, CharFormat? stf, CharFormat? pf)
		: base(chars, t, 10, bl, p, x, y, ff, sff, tf, stf, pf){}
	
	public TuiFramedScrollingTextBoxDate(string chars, string t, uint bl, Placement p, int x, int y, CharFormat? ff = null, CharFormat? tf = null, CharFormat? pf = null)
		: this(chars, t, bl, p, x, y, ff, ff, tf, tf, pf){}
	
	public TuiFramedScrollingTextBoxDate(string t, uint bl, Placement p, int x, int y, CharFormat? ff, CharFormat? sff, CharFormat? tf, CharFormat? stf, CharFormat? pf)
		: this(null, t, bl, p, x, y, ff, sff, tf, stf, pf){}
	
	public TuiFramedScrollingTextBoxDate(string t, uint bl, Placement p, int x, int y, CharFormat? ff = null, CharFormat? tf = null, CharFormat? pf = null)
